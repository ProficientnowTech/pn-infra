...
display_warning() {
	...
	echo ""
	echo -e "${YELLOW}[WARNING]${NC}	${RED}╔═══════════════════════════════════════════════════════════════════════════╗${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║                                                                           ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║                           !!!CRITICAL WARNING!!!                          ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║                                                                           ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║  This script will PERMANENTLY DESTROY ALL DATA in the platform:           ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║                                                                           ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║  • All ArgoCD applications                                                ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║  • All Helm releases                                                      ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║  • All platform namespaces                                                ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║  • All Custom Resource Definitions (CRDs)                                 ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║  • All Persistent Volumes and Claims                                      ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║  • All Ceph data on physical disks                                        ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║  • All application data, databases, secrets                               ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║                                                                           ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║  This action is IRREVERSIBLE. There is NO UNDO.                           ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║                                                                           ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║  Affected nodes and disks:                                                ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║    • k8s-master-01: /dev/sdb                                              ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║    • k8s-master-02: /dev/sdb                                              ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║    • k8s-master-03: /dev/sdb                                              ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║    • k8s-master-04: /dev/sda, /dev/sdb, /dev/sdc, /dev/sdd, /dev/sde      ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║    • k8s-worker-02: /dev/sdb                                              ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║    • k8s-worker-10: /dev/sda, /dev/sdb                                    ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}║                                                                           ║${NC}"
	echo -e "${YELLOW}[WARNING]${NC}	${RED}╚═══════════════════════════════════════════════════════════════════════════╝${NC}"
	echo ""
